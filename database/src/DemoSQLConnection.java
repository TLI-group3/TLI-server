...
public class DemoSQLConnection {
    ...
    public static void insertInstallments(Connection connection, String installments) {
        try {
            Statement statement = connection.createStatement();
            ...
            sqlCommand = "INSERT INTO plans (clientID, cars) VALUES('1007212080', + installments)";
            statement.executeUpdate(sqlCommand);
        }
        catch (SQLException e) {
            System.out.println(e);
